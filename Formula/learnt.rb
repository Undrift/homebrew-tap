class Learnt < Formula
  ...
  on_macos do
    on_arm do
      version "0.5.13"
      url "https://github.com/Undrift/homebrew-tap/releases/download/learnt-v0.5.13/learnt-darwin-arm64.tar.gz"
      sha256 "03b08cef3d39d017d99ca06fe71f55da5b55526e1db5e5fe34cc77d4788c9ee6"
    end
    on_intel do
