class Learnt < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Undrift/homebrew-tap/releases/download/learnt-v0.5.4/learnt-darwin-arm64.tar.gz"
      sha256 "6a0a20d9c9ce4af3f7722efa1f810f6383214bec17fd65f0061df87326bf510a"
    end
    on_intel do
