class Learnt < Formula
  ...
  on_macos do
    on_arm do
      version "0.5.6"
      url "https://github.com/Undrift/homebrew-tap/releases/download/learnt-v0.5.6/learnt-darwin-arm64.tar.gz"
      sha256 "51c6888d170aaddf50de747d9dbf6cbfea92757d3d144ab631937b3074f855fa"
    end
    on_intel do
