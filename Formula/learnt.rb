class Learnt < Formula
  ...
  on_macos do
    on_arm do
      version "0.5.9"
      url "https://github.com/Undrift/homebrew-tap/releases/download/learnt-v0.5.9/learnt-darwin-arm64.tar.gz"
      sha256 "80dc4c8b12bea589662108419d142f42810608f47ad3adbf4ddbb4d639fb8ad2"
    end
    on_intel do
